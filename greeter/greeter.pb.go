...
func (x *HelloResponse) GetWelcomeMsg() string {
	if x != nil {
		return x.WelcomeMsg
	}
	return ""
...
const file_greeter_greeter_proto_rawDesc = "" +
	...
	"\x03age\x18\x02 \x01(\x05R\x03age\"0\n" +
	"\rHelloResponse\x12\x1f\n" +
	"\vwelcome_msg\x18\x01 \x01(\tR\n" +
	"welcomeMsg2G\n" +
	"\vGreetPerson\x128\n" +
	"\x05SayHi\x12\x15.greeter.HelloRequest\x1a\x16.greeter.HelloResponse\"\x00B.Z,github.com/idiotcoffee/gRPC-learning/greeterb\x06proto3"
...
var file_greeter_greeter_proto_depIdxs = []int32{
	0, // 0: greeter.GreetPerson.SayHi:input_type -> greeter.HelloRequest
	1, // 1: greeter.GreetPerson.SayHi:output_type -> greeter.HelloResponse

...
const (
	RouteGuide_GetFeature_FullMethodName   = "/router.RouteGuide/GetFeature"
	RouteGuide_ListFeatures_FullMethodName = "/router.RouteGuide/ListFeatures"
	RouteGuide_RecordRoute_FullMethodName  = "/router.RouteGuide/RecordRoute"
	RouteGuide_RouteChat_FullMethodName    = "/router.RouteGuide/RouteChat"
)
